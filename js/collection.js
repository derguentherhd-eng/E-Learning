...
(function () {
  ...
  /* Entdeckerblick-Trophäe öffnet die Welt-5-Foto-Galerie */
  var w5slot = document.getElementById('ts-w5');
  if (w5slot && WW.openWorldGallery) {
    w5slot.classList.add('trophy-slot--clickable');
    w5slot.addEventListener('click', function () {
      if (!w5slot.classList.contains('is-empty')) WW.openWorldGallery();
    });
  }
