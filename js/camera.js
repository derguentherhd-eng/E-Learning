...
(function (global) {
  ...
  /* ── Übungen, die die Kamera-UI erhalten ────────────────────
     Bewusst OHNE Kamera:
     5.3  Formen suchen    → flüchtiges Zählen, kein Sammelmoment
     5.4  Wieland-Höhe     → Körpererfahrung, kein Foto-Motiv
     5.5  Straßenseite     → Handlung, kein Motiv
     5.7  Farbjagd         → bewusst kameralos (mit den Augen sammeln)
     5.8  Veränderungen    → bräuchte Vorher/Nachher-Vergleich, eigenes Feature
     5.9  Abbiegen         → Handlung, kein Motiv
  ────────────────────────────────────────────────────────────── */
  var CAMERA_ENABLED_IDS = ['5.1', '5.2', '5.6', '5.10', '5.11'];
