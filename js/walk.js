  ...
  function bodyForType(ex) {
    switch (ex.type) {
      ...
      case 'photo': {
        ...
        var isCamEx = WW.CAMERA_ENABLED_IDS && WW.CAMERA_ENABLED_IDS.indexOf(ex.id) >= 0;
        var baseHTML = '<div class="photo-grid" id="photos"></div>' +
        ...
        return isCamEx
          ? baseHTML
          : baseHTML + '<input class="visually-hidden" id="photo-input" type="file" accept="image/*" capture="environment">';
      }
      case 'tour':
